...
from app.models.inventory import Reconciliation, Discrepancy, InventoryUpload
...
async def upload_csv(
    ...
    current_user: User = Depends(check_role(["ADMIN", "INFRASTRUCTURE_ENGINEER"])),
):
...
async def start_reconciliation(
    ...
    AuditService.log_action(
        db, current_user, AuditActionType.RUN_RECONCILIATION, f"ID: {recon.id}"
    )
